...
void i2s_bus_init(i2s_bus_config *cfg) {
    // TODO: Why?
    gpio_num_t I2S_GPIO_BUS[] =
        {cfg->data_6, cfg->data_7, cfg->data_4, cfg->data_5, cfg->data_2, cfg->data_3, cfg->data_0, cfg->data_1};
    ...
    i2s_state.buf_a      = heap_caps_malloc(cfg->epd_row_width / 4, MALLOC_CAP_8BIT);
    i2s_state.buf_b      = heap_caps_malloc(cfg->epd_row_width / 4, MALLOC_CAP_8BIT);
    i2s_state.dma_desc_a = heap_caps_malloc(sizeof(lldesc_t), MALLOC_CAP_8BIT);
    i2s_state.dma_desc_b = heap_caps_malloc(sizeof(lldesc_t), MALLOC_CAP_8BIT);
